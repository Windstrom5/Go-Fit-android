...
class HistoryInstrukturAdapter(private var itemList: List<historyinstruktur>, context: Context) :
    RecyclerView.Adapter<HistoryInstrukturAdapter.ViewHolder>(), Filterable {
    private var filteredItemList: MutableList<historyinstruktur>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.historyinstruktur, parent, false)
    ...
    fun setItemList(listClass: Array<historyinstruktur>){
    ...
    override fun getFilter(): Filter {
        return object : Filter(){
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                val filtered: MutableList<historyinstruktur> = java.util.ArrayList()
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                ...
                filteredItemList.addAll(filterResults.values as List<historyinstruktur>)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        init {
            tvKelas = itemView.findViewById(R.id.tv_namaKelasHistoryInstruktur)
            tvTanggal = itemView.findViewById(R.id.tv_tanggalHistoryInstruktur)
            tvjam = itemView.findViewById(R.id.tv_jamHistoryInstruktur)
            cvItem = itemView.findViewById(R.id.card_view)
            tvstatus = itemView.findViewById(R.id.tv_statusHistoryInstruktur)
        }
    }
}