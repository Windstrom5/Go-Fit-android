...
class HomePegawaiActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener  {
    ...
    private fun getName(email:String,pass: String){
        ...
        val StringRequest: StringRequest = object : StringRequest(
            Method.GET,
            PegawaiApi.GET_BY_USERNAME + email + "/" + pass,
            ...
            Response.ErrorListener { error ->
                ...
                try {
                    ...
                    Toast.makeText(
                        this@HomePegawaiActivity,
                        "Akun Belum Terdaftar",
                        Toast.LENGTH_SHORT
                    ).show()
                } catch (e: Exception) {
                    Toast.makeText(this@HomePegawaiActivity, e.message, Toast.LENGTH_SHORT).show()
                }
            }
        ) {
        ...
        if (item.itemId == R.id.menulogout) {
            ...
            builder.setMessage("Want to log out?")
                ...
                .setPositiveButton("YES", object : DialogInterface.OnClickListener {
                    override fun onClick(dialogInterface: DialogInterface, i: Int) {
                        startActivity(Intent(this@HomePegawaiActivity, MainActivity::class.java))
                    }
                })
                .show()
    ...
    override fun onBackPressed() {
        ...
        val builder: androidx.appcompat.app.AlertDialog.Builder = androidx.appcompat.app.AlertDialog.Builder(this@HomePegawaiActivity)
        builder.setMessage("Want to log out?")
            .setNegativeButton("No", object : DialogInterface.OnClickListener {
                override fun onClick(dialogInterface: DialogInterface, i: Int) {
